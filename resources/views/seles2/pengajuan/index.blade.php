                    ...
                    <div class="modal-dialog modal-dialog-centered modal-mobile">
                        <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
                            ...
                            <div class="modal-body p-3">
                                ...
                                @if ($row->bukti_file)
@php
    $modalIdBukti = 'modal-bukti-' . $row->id_pengeluaran;
@endphp
...
<button type="button"
    ...
    <i class="bi bi-paperclip me-1"></i> Lihat Bukti Lampiran
                ...
                @if ($row->bukti_file)
    @php
        // Sesuaikan ini dengan cara kamu menyimpan path bukti.
        // Kalau kamu sudah punya route yang mengembalikan file (inline), pakai itu:
        $buktiUrl = route('sales.pengajuan.bukti', $row->id_pengeluaran);
    ...
    <div class="modal fade" id="modal-bukti-{{ $row->id_pengeluaran }}" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-mobile">
            <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
                <div class="modal-header border-0 pb-0 pt-3 px-3">
                    ...
                    <div class="bg-light border border-secondary border-opacity-10 rounded-3 p-2">
                        ...
                        @else
                            <div class="text-center text-muted small p-3">
                                File tidak bisa dipreview. Silakan buka/download.
                            </div>
                        @endif
                    </div>
                </div>
                ...
                <div class="modal-footer border-0 bg-light px-3 py-3 d-flex gap-2">
                    <a href="{{ $buktiUrl }}" class="btn btn-primary rounded-pill fw-bold flex-grow-1 btn-action-amber" target="_blank">
                        <i class="bi bi-box-arrow-up-right me-1"></i> Buka
                    </a>
                    <button type="button" class="btn btn-secondary rounded-pill fw-bold flex-grow-1" data-bs-dismiss="modal">
                        Tutup
                    </button>
                </div>
            </div>
